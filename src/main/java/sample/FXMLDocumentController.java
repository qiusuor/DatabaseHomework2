...
//    private Label label;
    ...
    @FXML
    private TableColumn<Student, String> Sage;
    @FXML
...
//        }
        if(event.getSource()==deleteRecord){
            if(sNum.getText().trim().length()>0){
                try {
                    String deleteStatemenet="DELETE FROM Student WHERE Sid='"+sNum.getText().trim()+"'";
                    MysqlConnector mysqlConnector = new MysqlConnector();
                    System.out.println(deleteStatemenet);

                    Connection con = mysqlConnector.solution("DataBaseCourse");
                    Statement statement = null;

                    statement = con.createStatement();
                   statement.executeUpdate(deleteStatemenet);
                    con.close();
                    sqlStatement.setText(deleteStatemenet);
                }
                catch (Exception e){
                    e.printStackTrace();
                }
        ...
        else if(event.getSource()!=insertRecord){
...
//                    Sname.set
            ...
            if(SidInsert.equals("NULL")){
                ...
                if(SageInsert.equals("NULL"))
                    insertStatement="INSERT INTO Student (Sid,Sname,Sage,Ssex,Sclass,Sdept,Saddress) VALUES ('"+SidInsert+"',"+SnameInsert+",NULL"+","+SsexInsert+","+SclassInsert+","+SdeptInsert+","+SaddressInsert+")";
                else
                    insertStatement="INSERT INTO Student (Sid,Sname,Sage,Ssex,Sclass,Sdept,Saddress) VALUES ('"+SidInsert+"',"+SnameInsert+","+SageInsert+","+SsexInsert+","+SclassInsert+","+SdeptInsert+","+SaddressInsert+")";
    ...
    public void updataInfo(TableColumn.CellEditEvent edittedCell)

    {
//        System.out.println(edittedCell.getRowValue());
//        System.out.println(edittedCell.getTableColumn());
//        System.out.println(edittedCell.getTablePosition());

        Student personSelected =  resultTable.getSelectionModel().getSelectedItem();
        String editStatement="";
//        if(edittedCell.)
        if(edittedCell.getTableColumn()==Sname){
            personSelected.setSname(edittedCell.getNewValue().toString());
           editStatement="UPDATE Student SET "+"Sname= '"+personSelected.getSname()+"' "+"WHERE Sid='"+personSelected.getSid()+"'";
        }
        if(edittedCell.getTableColumn()==Sage){
            personSelected.setSage(edittedCell.getNewValue().toString());
            editStatement="UPDATE Student SET "+"Sage= "+personSelected.getSage()+" "+"WHERE Sid='"+personSelected.getSid()+"'";

        }
        if(edittedCell.getTableColumn()==Ssex){
            personSelected.setSsex(edittedCell.getNewValue().toString());
            editStatement="UPDATE Student SET "+"Ssex= '"+personSelected.getSsex()+"' "+"WHERE Sid='"+personSelected.getSid()+"'";

        }
        if(edittedCell.getTableColumn()==Sclass){
            personSelected.setSclass(edittedCell.getNewValue().toString());
            editStatement="UPDATE Student SET "+"Sclass= '"+personSelected.getSclass()+"' "+"WHERE Sid='"+personSelected.getSid()+"'";

        }if(edittedCell.getTableColumn()==Sdept){
        personSelected.setSdept(edittedCell.getNewValue().toString());
        editStatement="UPDATE Student SET "+"Sdept= '"+personSelected.getSdept()+"' "+"WHERE Sid='"+personSelected.getSid()+"'";

    }if(edittedCell.getTableColumn()==Saddress){
        personSelected.setSaddress(edittedCell.getNewValue().toString());
        editStatement="UPDATE Student SET "+"Saddress= '"+personSelected.getSaddress()+"' "+"WHERE Sid='"+personSelected.getSid()+"'";
        ...
        try {
            ...
            Connection con = mysqlConnector.solution("DataBaseCourse");
            Statement statement = null;
            sqlStatement.setText(editStatement);
            statement = con.createStatement();
            statement.executeUpdate(editStatement);
...
//        Sid=new TableColumn<Student, String>();
        ...
        Sclass.setCellValueFactory(new PropertyValueFactory<Student, String>("Sclass"));
        Sage.setCellValueFactory(new PropertyValueFactory<Student, String>("Sage"));

        resultTable.setEditable(true);

//        Sid.setCellFactory(TextFieldTableCell.<Student>forTableColumn());
        Sname.setCellFactory(TextFieldTableCell.<Student>forTableColumn());
//        Sage.setCellFactory(TextFieldTableCell.<Student>forTableColumn());
        Sage.setCellFactory(TextFieldTableCell.<Student>forTableColumn());
        Ssex.setCellFactory(TextFieldTableCell.<Student>forTableColumn());

        Sclass.setCellFactory(TextFieldTableCell.<Student>forTableColumn());
        Sdept.setCellFactory(TextFieldTableCell.<Student>forTableColumn());
        Saddress.setCellFactory(TextFieldTableCell.<Student>forTableColumn());
